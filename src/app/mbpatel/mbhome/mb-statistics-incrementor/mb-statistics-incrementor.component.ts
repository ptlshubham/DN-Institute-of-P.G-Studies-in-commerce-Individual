...
@Component({
  selector: 'app-mb-statistics-incrementor',
  templateUrl: './mb-statistics-incrementor.component.html',
  styleUrls: ['./mb-statistics-incrementor.component.css']
})
export class MbStatisticsIncrementorComponent implements OnInit {
