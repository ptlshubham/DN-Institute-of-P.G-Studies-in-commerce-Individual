...
@Component({
  selector: 'app-mb-left-image-text',
  templateUrl: './mb-left-image-text.component.html',
  styleUrls: ['./mb-left-image-text.component.css']
})
export class MbLeftImageTextComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.router.url == "/mbpatel/basic/about") {
